# --- ये 3 लाइनें Railway पर बिना किसी सेटिंग के लाइब्रेरी इंस्टॉल कर देंगी ---
import subprocess
import sys
...
# ⚠️ ध्यान दें: यहाँ अपना नया टोकन डालें (अगर बदला है तो)
...
# --- Railway ke liye ye main block bohot zaroori hai ---
